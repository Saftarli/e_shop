...
Revision ID: 60cd8346875e
Revises: 
Create Date: 2024-11-20 20:41:21.664350
...
def upgrade():
    ...
    sa.Column('orders', shop.customers.models.JsonEcodedDict(), nullable=True),
    sa.PrimaryKeyConstraint('id'),
